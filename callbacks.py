...
async def ChattingAudioCallback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    bot_data = context.bot_data
    ...
    message_bot_sent = await context.bot.send_audio(chat_id=other_user_id,
                                                    audio=audio_file_id,
                                                    caption=caption,
                                                    write_timeout=30,
                                                    connect_timeout=30,
...
async def ChattingStickerCallback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    bot_data = context.bot_data
    ...
    message_bot_sent = await context.bot.send_sticker(chat_id=other_user_id,
...
async def CHattingPhotoCallback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    bot_data = context.bot_data
    ...
    message_bot_sent = await context.bot.send_photo(chat_id=other_user_id,
                                                    photo=photo_file_id,
                                                    caption=caption,
                                                    write_timeout=30,
                                                    connect_timeout=30,
